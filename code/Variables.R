...
runits_acs2015_vars<-
c(
`tot` = "B25063_001",  # :: GROSS RENT
`cash` = "B25063_002",  # With cash rent :: GROSS RENT
`100` = "B25063_003",  # With cash rent!!Less than $100 :: GROSS RENT
`149` = "B25063_004",  # With cash rent!!$100 to $149 :: GROSS RENT
`199` = "B25063_005",  # With cash rent!!$150 to $199 :: GROSS RENT
`249` = "B25063_006",  # With cash rent!!$200 to $249 :: GROSS RENT
`299` = "B25063_007",  # With cash rent!!$250 to $299 :: GROSS RENT
`349` = "B25063_008",  # With cash rent!!$300 to $349 :: GROSS RENT
`399` = "B25063_009",  # With cash rent!!$350 to $399 :: GROSS RENT
`449` = "B25063_010",  # With cash rent!!$400 to $449 :: GROSS RENT
`499` = "B25063_011",  # With cash rent!!$450 to $499 :: GROSS RENT
`549` = "B25063_012",  # With cash rent!!$500 to $549 :: GROSS RENT
`599` = "B25063_013",  # With cash rent!!$550 to $599 :: GROSS RENT
`649` = "B25063_014",  # With cash rent!!$600 to $649 :: GROSS RENT
`699` = "B25063_015",  # With cash rent!!$650 to $699 :: GROSS RENT
`749` = "B25063_016",  # With cash rent!!$700 to $749 :: GROSS RENT
`799` = "B25063_017",  # With cash rent!!$750 to $799 :: GROSS RENT
`899` = "B25063_018",  # With cash rent!!$800 to $899 :: GROSS RENT
`999` = "B25063_019",  # With cash rent!!$900 to $999 :: GROSS RENT
`1249` = "B25063_020",  # With cash rent!!$1 000 to $1 249 :: GROSS RENT
`1499` = "B25063_021",  # With cash rent!!$1 250 to $1 499 :: GROSS RENT
`1999` = "B25063_022",  # With cash rent!!$1 500 to $1 999 :: GROSS RENT
`2499` = "B25063_023",  # With cash rent!!$2 000 to $2 499 :: GROSS RENT
`2999` = "B25063_024",  # With cash rent!!$2 500 to $2 999 :: GROSS RENT
`3499` = "B25063_025",  # With cash rent!!$3 000 to $3 499 :: GROSS RENT
`3500` = "B25063_026",  # With cash rent!!$3 500 or more :: GROSS RENT
`nocash` = "B25063_027"  # No cash rent :: GROSS RENT
)
runits_acs2014_vars<-
c(
`tot` = "B25063_001",  # Estimate!!Total :: GROSS RENT
`cash`= "B25063_002",  # Estimate!!Total!!With cash rent :: GROSS RENT
`100` = "B25063_003",  # Estimate!!Total!!With cash rent!!Less than $100 :: GROSS RENT
`149` = "B25063_004",  # Estimate!!Total!!With cash rent!!$100 to $149 :: GROSS RENT
`199` = "B25063_005",  # Estimate!!Total!!With cash rent!!$150 to $199 :: GROSS RENT
`249` = "B25063_006",  # Estimate!!Total!!With cash rent!!$200 to $249 :: GROSS RENT
`299` = "B25063_007",  # Estimate!!Total!!With cash rent!!$250 to $299 :: GROSS RENT
`349` = "B25063_008",  # Estimate!!Total!!With cash rent!!$300 to $349 :: GROSS RENT
`399` = "B25063_009",  # Estimate!!Total!!With cash rent!!$350 to $399 :: GROSS RENT
`449` = "B25063_010",  # Estimate!!Total!!With cash rent!!$400 to $449 :: GROSS RENT
`499` = "B25063_011",  # Estimate!!Total!!With cash rent!!$450 to $499 :: GROSS RENT
`549` = "B25063_012",  # Estimate!!Total!!With cash rent!!$500 to $549 :: GROSS RENT
`599` = "B25063_013",  # Estimate!!Total!!With cash rent!!$550 to $599 :: GROSS RENT
`649` = "B25063_014",  # Estimate!!Total!!With cash rent!!$600 to $649 :: GROSS RENT
`699` = "B25063_015",  # Estimate!!Total!!With cash rent!!$650 to $699 :: GROSS RENT
`749` = "B25063_016",  # Estimate!!Total!!With cash rent!!$700 to $749 :: GROSS RENT
`799` = "B25063_017",  # Estimate!!Total!!With cash rent!!$750 to $799 :: GROSS RENT
`899` = "B25063_018",  # Estimate!!Total!!With cash rent!!$800 to $899 :: GROSS RENT
`999` = "B25063_019",  # Estimate!!Total!!With cash rent!!$900 to $999 :: GROSS RENT
`1249` = "B25063_020",  # Estimate!!Total!!With cash rent!!$1 000 to $1 249 :: GROSS RENT
`1499` = "B25063_021",  # Estimate!!Total!!With cash rent!!$1 250 to $1 499 :: GROSS RENT
`1999` = "B25063_022",  # Estimate!!Total!!With cash rent!!$1 500 to $1 999 :: GROSS RENT
`2000` = "B25063_023",  # Estimate!!Total!!With cash rent!!$2 000 to $2 499 :: GROSS RENT
`nocash` = "B25063_024"  # Estimate!!Total!!With cash rent!!$2 500 to $2 999 :: GROSS RENT
)

runits_dec2000_vars <-
c(
`tot` = "H062001", # Total: Specified renter-occupied housing units ::H62. Gross Rent [24]
`cash`= "H062002", # Total: With cash rent: ::H62. Gross Rent [24]
`100` = "H062003", # Total: With cash rent: Less than $100 ::H62. Gross Rent [24]
`149` = "H062004", # Total: With cash rent: $100 to $149 ::H62. Gross Rent [24]
`199` = "H062005", # Total: With cash rent: $150 to $199 ::H62. Gross Rent [24]
`249` = "H062006", # Total: With cash rent: $200 to $249 ::H62. Gross Rent [24]
`299` = "H062007", # Total: With cash rent: $250 to $299 ::H62. Gross Rent [24]
`349` = "H062008", # Total: With cash rent: $300 to $349 ::H62. Gross Rent [24]
`399` = "H062009", # Total: With cash rent: $350 to $399 ::H62. Gross Rent [24]
`449` = "H062010", # Total: With cash rent: $400 to $449 ::H62. Gross Rent [24]
`499` = "H062011", # Total: With cash rent: $450 to $499 ::H62. Gross Rent [24]
`549` = "H062012", # Total: With cash rent: $500 to $549 ::H62. Gross Rent [24]
`599` = "H062013", # Total: With cash rent: $550 to $599 ::H62. Gross Rent [24]
`649` = "H062014", # Total: With cash rent: $600 to $649 ::H62. Gross Rent [24]
`699` = "H062015", # Total: With cash rent: $650 to $699 ::H62. Gross Rent [24]
`749` = "H062016", # Total: With cash rent: $700 to $749 ::H62. Gross Rent [24]
`799` = "H062017", # Total: With cash rent: $750 to $799 ::H62. Gross Rent [24]
`899` = "H062018", # Total: With cash rent: $800 to $899 ::H62. Gross Rent [24]
`999` = "H062019", # Total: With cash rent: $900 to $999 ::H62. Gross Rent [24]
`1249` = "H062020", # Total: With cash rent: $1,000 to $1,249 ::H62. Gross Rent [24]
`1499` = "H062021", # Total: With cash rent: $1,250 to $1,499 ::H62. Gross Rent [24]
`1999` = "H062022", # Total: With cash rent: $1,500 to $1,999 ::H62. Gross Rent [24]
`2000` = "H062023", # Total: With cash rent: $2,000 or more ::H62. Gross Rent [24]
`nocash` = "H062024" # Total: No cash rent ::H62. Gross Rent [24]
)
